      ...
      >
        {selected && (
          <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
            <path d="M2 5L4 7L8 3" stroke="var(--background)" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        )}
      </div>
  ...
  return (
    <div className="max-w-6xl">
      ...
      <div className="mb-8 p-4 border border-[var(--border)] bg-[var(--background)]">
        {connected === null ? (
          <p className="text-xs text-[var(--foreground-muted)]">Checking connection...</p>
        ) : connected ? (
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-green-500" />
              <p className="text-xs text-[var(--foreground)]">
                {justConnected ? "Successfully connected to StockX" : "Connected to StockX"}
              </p>
            </div>
            <button
              onClick={disconnect}
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <p className="text-xs text-[var(--foreground)]">Not connected to StockX</p>
              </div>
              {oauthError && (
