        ...
        <section className="mt-20 md:mt-28 mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {outfitsWithProduct.slice(0, 4).map((outfit) => (
              <div key={outfit.id} className="rounded-t-xl border border-[var(--border)] overflow-hidden bg-[var(--background)] hover:shadow-md hover:border-[var(--foreground-muted)] transition-all duration-200">
        ...
        <section className="mt-20 md:mt-28 mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {relatedProducts.map((related) => (
              <div key={related.id} className="rounded-t-xl border border-[var(--border)] overflow-hidden bg-[var(--background)] hover:shadow-md hover:border-[var(--foreground-muted)] transition-all duration-200">
