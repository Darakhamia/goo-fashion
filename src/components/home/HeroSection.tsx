...
export function HeroSection() {
  return (
    ...
    <section
      data-home-section
      className="bg-[var(--background)] min-h-[calc(100svh-var(--home-nav-h))] pb-[var(--home-bottom-nav-h)] md:pb-0 flex flex-col items-center justify-center relative overflow-hidden"
    >
